...
| **(parallel)** | Primers + thermodynamics (Tm/GC → display → design) | 🟡 Phases 1 + 1.5 complete; Phase 2.1 (inline primer form) next |
...
| **Primers + thermo** | [`plans/primers.md`](plans/primers.md) | 🟡 Phases 1 + 1.5 complete (thermo QC; Inspector unified viewer/detail/**inline-editor**; enzyme-in-pane; CLI list/find) | Phase 2.1 — inline primer form (rides 1.5's edit-mode + confirm/cancel grammar) |
