...
| **(parallel)** | Primers + thermodynamics (Tm/GC → display → design) | 🟡 Phase 1 complete (thermo QC, Inspector 3-tab pane, CLI list/find) |
...
| **Primers + thermo** | [`plans/primers.md`](plans/primers.md) | 🟡 Phase 1 complete (thermo QC, Inspector 3-tab pane, CLI `primers list`/`find`) | Phase 2 — creation/editing (staged primer dialog) |
